...
@php
    ...
    $buttonClasses = \Illuminate\Support\Arr::toCssClasses([
        ...[
            "btn btn-size-{$stringSize} relative grid-flow-col items-center justify-center font-semibold outline-none transition duration-75 focus:ring-2",
            'pointer-events-none opacity-70' => $disabled,
            'flex-1' => $grouped,
            'rounded-lg' => ! $grouped,
            is_string($color) ? "btn-color-{$color}" : null,
            match ($size) {
        ...
        ...(
            $outlined ?
                [
                    'btn-outlined ring-1',
                    match ($color) {
                        'neutral' => 'text-neutral-950 ring-neutral-300 hover:bg-neutral-400/10 focus:ring-neutral-400/40',
                ...
                [
                    ...
                    ...match ($color) {
                        'neutral' => [
                            ...
                            'ring-1 ring-neutral-950/10' => ! $grouped,
                        ],
                        default => [
                            'bg-custom-600 hover:bg-custom-500 dark:bg-custom-500 dark:hover:bg-custom-400',
                            'focus:ring-custom-500/50 dark:focus:ring-custom-400/50' => ! $grouped,
                            'text-white' => ! $inverted,
                            'text-custom-900' => $inverted,
                        ],
                    },
                ]
        ),
    ...
    $buttonStyles = \Illuminate\Support\Arr::toCssStyles([
        \Filament\Support\get_color_css_variables($color, shades: [400, 500, 600]) => $color !== 'neutral',
    ]);
    ...
    $badgeContainerClasses = 'button-badge-ctn absolute -top-1 start-full z-[1] -ms-1 -translate-x-1/2 rounded-md bg-white rtl:translate-x-1/2 dark:bg-neutral-900';
